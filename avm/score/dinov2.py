...
# Override with DINOV2_SCORING_CHECKPOINT env var if the file lives elsewhere.
_CHECKPOINT_DEFAULT = os.environ.get(
    "DINOV2_SCORING_CHECKPOINT",
    "models/dinov2_vitb14_best.pt",
)
...
class DINOv2WithSealionScoringModel(ScoringModel):
    ...
    def __init__(
        ...
        checkpoint_path: str = _CHECKPOINT_DEFAULT,
        device: str = "cpu",
